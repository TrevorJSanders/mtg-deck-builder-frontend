...
export function DataTable<TData, TValue>({
  ...
  const { setSelectedRows } = useMTGContext();
  ...
  return (
    <div className="p-2 flex flex-col h-full">
      ...
      {/* Tabale Start */}
      <div className="my-2 flex-1 overflow-auto rounded-md border">
        <Table>
          <TableHeader>
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id} row="DONOTUSE">
